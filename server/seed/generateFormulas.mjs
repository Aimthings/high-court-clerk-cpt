...
const RAW = [
  ...
  lesson({ slug: 'countblank', name: 'COUNTBLANK', track: 'Math & stats', difficulty: 1,
  ...
  lesson({ slug: 'product', name: 'PRODUCT', track: 'Math & stats', difficulty: 1,
  ...
  lesson({ slug: 'sqrt', name: 'SQRT', track: 'Math & stats', difficulty: 1,
  ...
  // ---- Lookup & reference ----
  lesson({ slug: 'vlookup', name: 'VLOOKUP', track: 'Lookup & reference', difficulty: 3,
  ...
  lesson({ slug: 'hlookup', name: 'HLOOKUP', track: 'Lookup & reference', difficulty: 3,
  ...
  lesson({ slug: 'rank', name: 'RANK', track: 'Advanced', difficulty: 3,
