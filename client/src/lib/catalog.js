...
export const CATALOG = [
  ...
  {
    id: 'excel_mock', label: 'Excel Mock', priceFounding: 119, priceStandard: 137, caps: ['excelMocks'], start: '/mocks',
    tag: 'Excel practical', features: ['All Excel spreadsheet mocks', 'Server-graded, layout-independent', 'Mistake breakdown per part'],
  },
  {
    id: 'excel_complete', label: 'Excel Complete', priceFounding: 139, priceStandard: 160, caps: ['excelMocks', 'formulaLibrary'], start: '/practice/formulas',
    tag: 'Mocks + formulas', features: ['Everything in Excel Mock', 'Full Formula Library — 37 lessons', 'Graded formula practice'],
  },
  {
    id: 'all_access', label: 'All-Access', priceFounding: 169, priceStandard: 194, caps: ['typingCourse', 'typingMocks', 'excelMocks', 'formulaLibrary'], start: '/mocks',
