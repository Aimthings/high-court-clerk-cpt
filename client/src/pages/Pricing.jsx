...
// Pricing — the product catalog. One-time purchases, 2 months, no auto-renewal.
    ...
    <div className="page">
      <div className="ref-header">
        ...
        <p className="page-sub">
          Buy only the paper you need, or take everything. Each is a one-time purchase with 2 months
